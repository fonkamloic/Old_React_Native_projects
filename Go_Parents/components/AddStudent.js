            ...
            return (
                <View style={styles.container}>
                    ...
                    <View style={[styles.sex, styles.each]}>
                        ...
                        <Picker selectedValue={this.state.sex} style={{height: 40, width: 40, marginTop: -6}} onValueChange={(itemValue, itemIndex) =>{
                    ...
                    <Text style={{paddingLeft: 15, fontStyle: 'italic', fontSize: 17,  marginTop: -15}}>{this.state.sex}</Text>
